...
public class MenuIterativo {
    ...
    public static void run(){
        ...
        while (bool){
            ...
            MenuOperacoes operacao = MenuIterativo.getMenuOperacoes(in);
            ...
            switch(operacao){
                case CADASTRAR:
                    {
                        ...
                        while(boolCadastrar){
                            MenuCadastrar cadastrar = MenuIterativo.getCadastrar(in);
                            switch(cadastrar){
                ...
                case EXCLUIR:
                    {    
                        ...
                        MenuExcluir excluir = MenuIterativo.getExcluir(in);
                        while(boolExcluir){  
                            switch(excluir){
    ...
    public static MenuOperacoes getMenuOperacoes(Scanner scanner){
    ...
    public static MenuCadastrar getCadastrar(Scanner scanner){
        System.out.println("\nDigite a opção desejada: " +
    ...
    public static MenuExcluir getExcluir(Scanner scanner){
        System.out.println("\nDigite a opção desejada: " +
